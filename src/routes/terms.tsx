      ...
      <main className="container mx-auto max-w-2xl px-4 py-16">
        ...
        <div className="space-y-10">
          <Section title="1. About Lokal">
            <p>
              These Terms govern your use of <strong className="text-foreground">lokalshops.co.uk</strong> ("Lokal",
              "we", "us"). Lokal is a marketplace platform that connects customers with independent
              African and Caribbean stores. By using the platform you agree to these Terms.
            </p>
            <p>
              Lokal acts as a <strong className="text-foreground">technology platform only</strong>. We are not a
              party to any transaction between a customer and a merchant. The contract for goods or
              services is formed directly between the customer and the merchant.
            </p>
          </Section>
          ...
          <Section title="4. Merchant terms">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Comply with all applicable UK laws including consumer protection, food safety (if applicable), and anti-money-laundering regulations.</li>
              <li>Not list counterfeit, prohibited, or illegal goods.</li>
              <li>Ensure your bank details are correct — Lokal is not responsible for misdirected payments caused by incorrect details.</li>
          ...
          <Section title="5. Payments">
            ...
            <p>
              ...
              to introduce fees in future with reasonable notice to merchants.
            </p>
          </Section>
